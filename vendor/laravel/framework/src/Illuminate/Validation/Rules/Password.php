...
class Password implements Rule, DataAwareRule, ValidatorAwareRule
{
    ...
    protected function getErrorMessage($key)
    {
        ...
        $messages = [
            'validation.password.mixed' => '비밀번호에는 소문자와 대문자가 포함되어야 합니다',
            'validation.password.letters' => '비밀번호에는 문자가 포함되어야 합니다.',
            'validation.password.symbols' => '비밀번호에는 특수문자가 포함되어야 합니다.',
            'validation.password.numbers' => '비밀번호에는 숫자가 포함되어야 합니다',
