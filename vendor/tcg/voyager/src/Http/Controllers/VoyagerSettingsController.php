...
class VoyagerSettingsController extends Controller
{
    public function index()
    {
        ...
        //siilver
        $groups_data = Voyager::model('Setting')
            ->when(User::isSilverjava(), function ($query) {
                $query->whereNotIn('group', ['Site', 'Admin']);
            })
        ...
        else if(Str::contains($active, '가구용')) {
            $nameLabel = '변수';
            $descLabel = '설명';
        }
        else if(Str::contains($active, '개인용')) {
            $nameLabel = '변수';
            $descLabel = '설명';
        }
        else if(Str::contains($active, '부가조사')) {
            $nameLabel = '차수';
            $descLabel = '설명';
        }
        else if(Str::contains($active, '업로드허용')) {
            $nameLabel = '확장자';
            $descLabel = '설명';
        }
        else {
        ...
        return Voyager::view('voyager::settings.index', compact('settings', 'groups', 'active', 'nameLabel', 'descLabel'));
    }
    ...
    public function store(Request $request)
    {
        ...
        //siilver
        request()->session()->put('setting_tab',$request->input('group'));
