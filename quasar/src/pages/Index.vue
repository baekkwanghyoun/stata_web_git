                      ...
                      <div class="row">
                        <div class="col-12 q-pb-lg " >
                          <q-item class="row items-center">
                            ...
                            <div class="col-8">
                              <q-item-section>
                                <q-input @keydown.enter.prevent="submit" outlined dense v-model="add_h" style=""  placeholder="추가할 변수를 입력하세요. 예1) h0141      예2) h0151 h0152"  />
                              </q-item-section>
                            </div>
                          </q-item>
                          <q-item class="row items-center">
                            ...
                            <div class="col-8">
                              <q-item-section>
                                <q-input @keydown.enter.prevent="submit" outlined dense v-model="add_p" style=""  placeholder="추가할 변수를 입력하세요. 예1) p0101      예2) p0201 p0202"  />
                              </q-item-section>
                            </div>
                          </q-item>
                          ...
                          <q-item class="row items-start">
                            ...
                            <div>
                              <q-item-section>
                                <q-item-label class="text-black text-bold" caption>추가할 KLIPS 원자료 변수를 입력할 때는 변수의 6자리 숫자 중 조사차수를 의미하는 첫 2자리 숫자를 제외한 나머지 4자리 숫자만을 포함한 변수명을 입력해야 합니다. <br>(예) h220141 → h0141 또는 p220201 p220202 → p0201 p0202
                                </q-item-label>
                              </q-item-section>
                            </div>
                          </q-item>
<!--
                          <q-item-label class="q-pl-lg text-black text-bold" caption> ※
                          </q-item-label>
                          <q-item-label class="q-pl-lg text-black text-bold" caption>추가할 KLIPS 원자료 변수를 입력할 때는 변수의 6자리 숫자 중 조사차수를 의미하는 첫 2자리 숫자를 제외한 나머지 4자리 숫자만을 포함한 변수명을 입력해야 합니다. <br>&nbsp;&nbsp;&nbsp;&nbsp;(예) h220141 → h0141 또는 p220201 p220202 → p0201 p0202
                          </q-item-label>-->
                      ...
                      <template v-slot:header>
                        ...
                        <q-item-section style="margin-left: 10px">
                          <q-item-label class="text-weight-bold " style="color: #400080" >
                            ...
                            <q-badge v-if="chk_add_a()" class="q-ml-md" color="green-6" align="middle" >
                      ...
                      <div class="row">
                        <div class="col-12 q-pb-lg " >
                          <div class="col-12 scroll overflow-hidden" >
                            ...
                            <q-item-label class="q-pl-md text-black text-bold" caption>※ 최대 3개차수 동시선택 가능<br>
                              ※ 부가조사 변수 입력시 부가조사 차수를 선택하신 후 첫 2자리 숫자(차수)를 제외한 나머지 4자리 숫자를 포함한 변수명을 입력해야 합니다. <br>&nbsp;&nbsp;&nbsp;&nbsp;(예) a221101 → a1101
                            </q-item-label>
              ...
              <q-list bordered class="rounded-borders ">
                <q-expansion-item group="somegroup"    label="">
                  ...
                  <div class="q-pa-lg">
                    ...
                    <div class="q-mb-xl">
                      <p class="text-subtitle1 text-bold"><q-icon name="star" color="primary"></q-icon> STEP2 KLIPS 원자료 변수 추가(필수 아님)</p>
                      <p class="text-body2" style="white-space: pre-wrap;">사용자가 원하는 KLIPS의 원자료 변수를 추가하여 데이터를 생성할 수 있습니다.<br>
                        <label class=" text-green" ><q-badge color="green" align="middle" class="q-mr-sm text-weight-bolder q-py-xs q-mb-xs">1</q-badge>
                          <span class="text-weight-bolder">가구용</span>
                          ...
                          <span class="text-weight-bolder">개인용</span>
                        </label> 변수를 구분하여 변수를 입력하면 해당 변수를 포함한 데이터가 생성됩니다.
변수 입력시에는 변수의 6자리 숫자 중 조사차수를 의미하는 첫 2자리 숫자를 제외한 나머지 4자리 숫자만을 포함한 변수명을 입력해야 합니다.
단, 변수를 여러 개 입력시 변수간에는 공백으로 구분하면 됩니다.
                    ...
                    <!--새로추가-->
                    <div class="q-mb-xl">
                      <p class="text-subtitle1 text-bold"><q-icon name="star" color="primary"></q-icon> STEP2 KLIPS 부가조사 원자료 변수 추가(필수아님)</p>
                      <p class="text-body2" style="white-space: pre-wrap;">사용자가 원하는 KLIPS 부가조사의 변수를 추가하여 데이터를 생성할 수 있습니다.
부가조사 차수를 선택한 후 변수를 입력하면 해당 변수를 포함한 데이터가 생성됩니다.
변수 입력시에는 변수의 6자리 숫자 중 조사차수를 의미하는 첫 2자리 숫자를 제외한 나머지 4자리 숫자만을 포함한 변수명을 입력해야 합니다.
단, 변수를 여러 개 입력시 변수간에는 공백으로 구분하면 됩니다.
                      </p>
                      <q-card bordered  flat>
                        <q-card-section>
                          <q-img bordered class="border" src="~assets/howto/5-1.jpg" transition="fade" />
                        </q-card-section>
                      </q-card>
                    </div>
    ...
    data() {
      return {
        ...
        kt_select2_3_data: [
          ...
          ['h_inc_5',	'금융소득 (단위: 만원)'],
          ['h_inc_6',	'부동산소득 (단위: 만원)'],
          ['h_incomeq',	'소득10분위 (1=최하위 10%, 2=최하위 10%~20%... 10=최상위 10%)'],
          ['h_asset_1',	'금융자산 (단위: 만원)'],
          ['h_asset_2_1',	'부동산자산(거주주택 제외): 연속형 (단위: 만원) (1차년도는 모두 결측치)'],
          ['h_asset_2_2',	'부동산자산(거주주택 제외): 범주형 (1=1천만원 미만, 2=1천~5천만원 미만, 3=5천~1억원 미만, 4=1억~5억원 미만, 5=5억~10억원 미만, 6=10억 이상) (1차년도는 모두 결측치)'],
          ['h_asset_3_1',	'임차보증금: 연속형 (단위: 만원) (1차년도는 모두 결측치)'],
          ['h_asset_3_2',	'임차보증금: 범주형 (1=1천만원 미만, 2=1천~5천만원 미만, 3=5천~1억원 미만, 4=1억~5억원 미만, 5=5억~10억원 미만, 6=10억 이상) (1차년도는 모두 결측치)'],
          ['h_debt_total',	'부채 총액(임대보증금 포함) (단위: 만원)'],
          ['h_debt_pay',	'부채 상환액 (단위: 만원/월)'],
          ['h_eqscale_ori',	'Original OECD 가구균등화지수'],
          ['h_eqscale_mod',	'Modified OECD 가구균등화지수'],
          ['h_sample98',	'98표본 원가구 여부 (1=원가구, 2=분가가구, 3=조사대상가구 아님)'],
          ['h_sample09',	'09통합표본 원가구 여부 (1=원가구, 2=분가가구, 3=조사대상가구 아님)'],
          ['h_sample18',	'18통합표본 원가구 여부 (1=원가구, 2=분가가구, 3=조사대상가구 아님)'],
          ['h_weight98',	'98표본 가구 가중치'],
          ['h_weight09',	'09통합표본 가구 가중치'],
          ['h_weight18',	'18통합표본 가구 가중치'],
          ],

        kt_select2_4_data: [
          ['p_sex',	'성별 (1=남자, 2=여자)'],
          ['p_age',	'나이'],
          ['p_rel',	'가구주와의 관계 (KLIPS 코드북 참조)'],
          ['p_edu',	'교육수준 (1=무학, 2=고졸미만, 3=고졸, 4=대재/중퇴, 5=전문대졸, 6=대졸이상)'],
          ['p_religion',	'종교 (1=무교, 2=불교, 3=기독교(개신교), 4=천주교, 5~10=KLIPS 코드북 참조)'],
          ['p_married',	'혼인상태 (1=미혼, 2=기혼유배우, 3=기혼무배우)'],
          ['p_region',	'거주지역 (16개시도, 19=세종시) (KLIPS 코드북 참조)'],
          ['p_econstat',	'ILO기준 경제활동 (1=취업자, 2=ILO기준 실업자, 3=비경제활동자)'],
          ['p_jobtype',	'일자리형태 (1=임금근로자, 2=비임금근로자)'],
          ['p_employ_type',	'취업형태 (1= 임금근로자, 2=자영업자, 3=무급가족종사자)'],
          ['p_job_status',	'종사상지위 (1=상용직, 2=임시직, 3=일용직, 4=고융주/자영업자, 5=무급가족종사자)'],
          ['p_wage',	'월평균 임금 (자영업자는 소득) (단위: 만원)'],
          ['p_hours',	'주당 평균근로시간 (임금근로자)'],
          ['p_ind2000',	'업종 (한국표준산업분류 8차 개정: 2000년 분류) (KLIPS 코드북 참조)'],
          ['p_ind2007',	'업종 (한국표준산업분류 9차 개정: 2007년 분류) (KLIPS 코드북 참조)'],
          ['p_ind2017',	'업종 (한국표준산업분류 10차 개정: 2017년 분류) (KLIPS 코드북 참조)'],
          ['p_jobfam2000',	'직종 (한국표준직업분류 5차 개정: 2000년 분류) (KLIPS 코드북 참조)'],
          ['p_jobfam2007',	'직종 (한국표준직업분류 6차 개정: 2007년 분류) (KLIPS 코드북 참조)'],
          ['p_jobfam2017',	'직종 (한국표준직업분류 7차 개정: 2017년 분류) (KLIPS 코드북 참조)'],
          ['p_firm_size',	'종업원규모: 범주형 (1=10명 미만, 2=10명~29명, 3=30명~99명, 4=100명~299명, 5=300명~499명, 6=500명 이상)'],
          ['p_job_begin',	'취업시기 (년도와 월)'],
          ['p_sample98',	'98표본 원가구 여부 (1=원가구, 2=분가가구, 3=조사대상가구 아님)'],
          ['p_sample09',	'09통합표본 원가구 여부 (1=원가구, 2=분가가구, 3=조사대상가구 아님)'],
          ['p_sample18',	'18통합표본 원가구 여부 (1=원가구, 2=분가가구, 3=조사대상가구 아님)'],
          ['p_weight98_l',	'98표본 종단가중치'],
          ['p_weight98_c',	'98표본 횡단가중치'],
          ['p_weight09_l',	'09통합표본 종단가중치'],
          ['p_weight09_c',	'09통합표본 횡단가중치'],
          ['p_weight18_l',	'18통합표본 종단가중치'],
          ['p_weight18_c',	'18통합표본 횡단가중치'],
        ],
...
*/
    ...
    methods: {
      ...
      chk_add_a() {
        let selected_add_a=false;
        this.a_wave.forEach(function(obj) {
          if(obj != null) {
            selected_add_a = true;
          }
          console.log(obj);
        ...
        this.add_a.forEach(function(obj2) {
          if(obj2 != null) {
            selected_add_a = true;
          }
          console.log(obj2);
