                    ...
                    <q-expansion-item  class="step2-3 q-mb-lg" icon="family_restroom" label="추가 변수 입력" header-class="text-grey-10" >
                      ...
                      <div class="row">
                        <div class="col-12 q-pb-lg " >
                          ...
                          <q-item-label class="q-pl-lg text-black text-bold" caption> ※ 추가할 KLIPS 원자료 변수를 입력할 때는 변수의 6자리 숫자 중 조사차수를 의미하는<br> &nbsp;&nbsp;&nbsp;&nbsp;첫 2자리 숫자를 제외한 나머지 4자리 숫자만을 포함한 변수명을 입력해야 합니다. <br>&nbsp;&nbsp;&nbsp;&nbsp;(예) h220141 → h0141 또는 p220201 p220202 → p0201 p0202
