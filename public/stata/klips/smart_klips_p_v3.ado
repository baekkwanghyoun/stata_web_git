...
=====================================================================*/
	...
	qui foreach v of local v1   {
			...
			if "`website'"=="" {
				if "`v'"=="01" | "`v'"=="12" | "`v'"=="13" | "`v'"=="14" | "`v'"=="15"| "`v'"=="16" | "`v'"=="17"| "`v'"=="18"| "`v'"=="19" | "`v'"=="20"  | "`v'"=="21" | "`v'"=="22" | "`v'"=="23" {
					use klips`v'p, clear
				}
...
/***** 노동패널팀 수정: 교육수준(p_edu) 변수 수정 *****/								
						...
						* 11번 : 업종  
						    ...
						    if  "`v'"=="12" | "`v'"=="13" |"`v'"=="14" |"`v'"=="15"|"`v'"=="16" |"`v'"=="17"| "`v'"=="18"| "`v'"=="19" | "`v'"=="20" | "`v'"=="21"| "`v'"=="22" | "`v'"=="23"    {   
								gen ``i''=p`v'0341						
								mvdecode ``i'' , mv(-1 999=.) 
							}
							else {
						...
						* 10번 : 취업시기 
						...
						/*================================================*/
							...
							else if "`v'"=="13" |  "`v'"=="14"| "`v'"=="15" | "`v'"=="16"| "`v'"=="17"| "`v'"=="18"| "`v'"=="19"| "`v'"=="20"  | "`v'"=="21"| "`v'"=="22" | "`v'"=="23"    {
								gen ``i''=sw`v'p_l
							}
							else {
								gen ``i''=.
...
/***** 노동패널팀 수정: 18통합표본 횡단가중치 (p_weight18_c) 변수 추가 *****/
