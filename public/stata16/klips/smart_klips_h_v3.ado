	...
	qui foreach v of local v1   {						
	  ...
	  * 소득변수는 앞서 만든다. 
	  ...
	  tempvar inc1
				...
				else if  "`v'"=="19" | "`v'"=="20" | "`v'"=="21"| "`v'"=="22"| "`v'"=="23" {
		    ...
		    * 8번 
			tempvar inc3
			     ...
			     if "`v'"=="09" | "`v'"=="10" | "`v'"=="11"|"`v'"=="12" | "`v'"=="13" | "`v'"=="14" | "`v'"=="15"| "`v'"=="16" | "`v'"=="17" | "`v'"=="18"| "`v'"=="19"  | "`v'"=="20" | "`v'"=="21"| "`v'"=="22" | "`v'"=="23"  {
						 tempvar h`v'2182
						 gen `h`v'2182'=.
			...
			* 10번 : 금융소득 			
				...
				if "`v'"=="01" {
							tempvar h`v'2113 h`v'2114 h`v'2115 h`v'2116
							gen `h`v'2113'=. 
							gen `h`v'2114'=. 
							gen `h`v'2115'=. 
							gen `h`v'2116'=.
							
							mvdecode h`v'2112 `h`v'2113' `h`v'2114' `h`v'2115' `h`v'2116', mv(-1 99999  999999 9999=.)
							egen   `inc5'=rowtotal(h`v'2112 `h`v'2113' `h`v'2114' `h`v'2115' `h`v'2116'), miss 
...
/***** 노동패널팀 수정: 가구주의 교육수준(h_hedu) 변수 수정 *****/
			...
			* 가중치 변수 (09통합표본) 
			    ...
			    if "`v'"=="12" |"`v'"=="13" | "`v'"=="13" | "`v'"=="14"| "`v'"=="15" | "`v'"=="16"| "`v'"=="17"| "`v'"=="18" | "`v'"=="19" | "`v'"=="20" | "`v'"=="21"| "`v'"=="22"| "`v'"=="23"    {
				gen   ``i''=sw`v'h				
				}
