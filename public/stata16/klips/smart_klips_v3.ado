...
drop if vname==""
	quietly {
		export excel using "var_name.xlsx", replace first(variable)	
		export delimited using "var_name.csv", replace 
		unicode convertfile var_name.csv var_name_1.csv, dstencoding(cp949)
		capture erase var_name.csv
		shell ren var_name_1.csv var_name.csv
	}
