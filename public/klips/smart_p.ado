...
=============================================*/
	...
	qui foreach v of local v1   {
			...
			if "`website'"=="" {
				if "`v'"=="01" | "`v'"=="12" | "`v'"=="13" | "`v'"=="14" | "`v'"=="15"| "`v'"=="16" | "`v'"=="17" | "`v'"=="18" | "`v'"=="19" | "`v'"=="20" | "`v'"=="21"{
					use klips`v'p, clear
				}
	        ...
	        forvalues i=1/`NV' {			
						...
						* 5번 
							...
							replace ``i'' =. if ``i'' ==1 
							replace ``i'' =1 if ``i'' ==2 
							replace ``i'' =2 if ``i'' ==3 | ``i'' ==4 
							replace ``i'' =2 if ``i'' ==5 & `bb' !=1 
							replace ``i'' =3 if ``i'' ==5 
							replace ``i'' =3 if (``i'' ==6 | ``i'' ==7) & `bb' !=1 
							replace ``i'' =4 if ``i'' ==6
							replace ``i'' =5 if ``i'' ==7 | ``i'' ==8 | ``i'' ==9 				
							label var ``i'' "교육수준(1=무학, 2=고졸미만, 3=고졸, 4=전문대졸, 5=대졸이상)"  
						}
						...
						* 16번 : 주당근로시간  : 임금 근로자 
						...
						mvdecode p`v'1006 p`v'1012 p`v'1031 , mv(-1 0 999 99=.)
						gen   ``i''=p`v'1006 if jobtype==1 & p`v'1003==1 & p`v'1011==1
						replace ``i''=p`v'1006 + p`v'1012 if jobtype==1 & p`v'1003==1 & p`v'1011==2 & p`v'1019==1
						replace ``i''=p`v'1006 + p`v'1012/4.3 if jobtype==1 & p`v'1003==1 & p`v'1011==2 & p`v'1019==2
						replace ``i''=p`v'1004 if jobtype==1 & p`v'1003==2
						...
						* 11번 : 업종  
						    ...
						    if  "`v'"=="12" | "`v'"=="13" |"`v'"=="14" |"`v'"=="15"|"`v'"=="16" |"`v'"=="17" | "`v'"=="18" | "`v'"=="19" | "`v'"=="20" | "`v'"=="21" {   
								gen ``i''=p`v'0341						
								mvdecode ``i'' , mv(-1 999=.) 
							}
							else {
						...
						* 10번 : 취업시기 
						...
						/*================================================*/
							...
							else if "`v'"=="13" |  "`v'"=="14"| "`v'"=="15" | "`v'"=="16"| "`v'"=="17" | "`v'"=="18" | "`v'"=="19" | "`v'"=="20" | "`v'"=="21" {
								gen ``i''=sw`v'p_l
							}
							else {
								gen ``i''=.
